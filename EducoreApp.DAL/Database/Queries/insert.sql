...
Insert into Courses values(0,'Comodity market', 'demo courese 1', 5000, GETUTCDATE(), GETUTCDATE())
Insert into Courses values(0,'Treading Course', 'demo courese 2', 10000, GETUTCDATE(), GETUTCDATE())
Insert into Courses values(2,'Treading Course Recording', 'recording testing', 888, GETUTCDATE(), GETUTCDATE())



Insert into Coupons values(1,0)
Insert into Coupons values(2,0)